{config, ...}: {
  programs.starship = with config.colorScheme.colors; {
    ...
    settings = {
      ...
      format = ''
        [ ](fg:#${base00} bg:#${orange})$username[ ](fg:#${orange} bg:#${base0E})$hostname[](fg:#${base0E} bg:#${base0B})$directory[](fg:#${base0B} bg:#${blue})$nix_shell[](fg:#${blue} bg:#${base00})$git_branch$git_status$fill$time
        $character'';
